        ...
        <Col md={6}>
          <Card className="shadow-sm h-100">
            ...
            <Card.Body className="d-flex flex-column gap-2">
              <Button as={Link} to="/books" variant="outline-primary" className="mb-2">
                📋 Xem Danh Sách Sách
              </Button>
          ...
          <Card className="shadow-sm h-100">
            ...
            <Card.Body>
              {books.slice(0, 3).map((book) => (
                <div key={book.id} className="d-flex justify-content-between py-1 border-bottom align-items-center">
